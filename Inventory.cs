...
namespace DreamMotors
{
    public partial class Inventory : Form
    {
        ...
        private void DisplayCars(List<Car> cars)
        {
            ...
            {
                Panel carPanel = new Panel { Width = 250, Height = 320, Margin = new Padding(10), BorderStyle = BorderStyle.FixedSingle };
                PictureBox pb = new PictureBox { Image = car.Image, SizeMode = PictureBoxSizeMode.StretchImage, Width = 230, Height = 150, Location = new Point(10, 10) };
                Label lblName = new Label { Text = car.Name, Location = new Point(10, 170), AutoSize = true, Font = new Font("Arial", 10, FontStyle.Bold) };
                Label lblPrice = new Label { Text = "$ " + car.Price.ToString("N0"), Location = new Point(10, 195), AutoSize = true, Font = new Font("Arial", 10) };
                Button btnView = new Button { Text = "View Details", Width = 230, Location = new Point(10, 230), BackColor = Color.Black, ForeColor = Color.White };
